...
\#applico un'analisi di regressione fra year e selling price e aggiungo un numero di colonne scelte a caso che poi andranno eliminate e non valutate per l'analisi solo per poter utilizzare il comando vif per lo studio della multicollinearità. E' giusto???
