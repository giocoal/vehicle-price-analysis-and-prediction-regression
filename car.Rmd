...
Il fatto che delle righe siano identiche è strano poiché è improbabile delle auto identiche siano dello stesso anno e abbiano esattamente lo stesso prezzo e numero di km. Inoltre non può essere nemmeno lo stesso veicolo rivenduto più volte perché l'attributo `owner` sarebbe diverso. Vedendo l'alto numero di queste righe sospette decidiamo dunque di toglierle dal datset.
...
#da verificare se tutto corretto: 
