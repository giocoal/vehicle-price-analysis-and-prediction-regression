...
Creo un subset delle variabili quantitative e successivamente elimino quelle che causano multicollinearitá (`log_engine_CC` e `seats`).
...
Al dataset appena creato aggiungo le colonne relative alle diverse modalità delle variabili categoriche. Per ogni attributo vengono generate n-1 nuove colonne dove n è il numero di modalità di quell'attributo.
