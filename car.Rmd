...
#controllo la correlazione dei dati
```{r controllo la correlazione}
ggcorr(modello_stepAIC$model, label = TRUE, label_size = 2.9, hjust = 1, layout.exp = 2)

ggcorr(modello_stepAIC_k$model, label = TRUE, label_size = 2.9, hjust = 1, layout.exp = 2)
```

#non sembra ci siano problemi di autocorrelazione per cui ora valuto i due modelli sulla base dell'autocorrelazione ecc....
