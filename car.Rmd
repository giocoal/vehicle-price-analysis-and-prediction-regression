...
Calcoliamo l'indice di asimmetria o *skewness*
...
#applico un plot per analizzare la variabile target sui residui
#(bisogna allargare l'asse x su alcuni plot per vedere meglio l'andamento)
#Nel secondo diagramma per la regressione ideale i punti dovrebbero trovarsi sulla retta diagonale e per questo motivo il nostro risultato non è così male da rifiutare il modello.
#negli altri grafici invece affinchè si ottenga una regressione lineare corretta le linee rosse si sarebbero dovute essere parallele all'asse x (dire se i risultati sono più o meno accettabili dopo aver allargato l'asse delle x per l'osservazione)
