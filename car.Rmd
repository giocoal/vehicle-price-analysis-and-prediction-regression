...
Provo a valutare la distribuzione logaritmica di alcune delle variabili numeriche
asimmetriche
...
par(mfrow=c(1,1))
```
Tutte le variabili numeriche considerate, tranne yaer, sembrano assumere una distribuzione più simmetrica se applicata
