...
Ció che risulta é un modello con un valore dell'R quadro aggiustato elevato `R-squared: 0.893`. Il problema di questo modello però è che molti degli attributi non sono significativi e alcuni di questi sono collineari.

Dalla tabella dei coefficienti si può osservare anche che dei molti attributi dovuti alla marca dell'auto quelli che presentano la significatività maggiore sono quelli corrispondenti alle macchine più lussuose. Questa cosa è dovuta al fatto che il prezzo di queste auto si discostava molto dalle altre a parità di motore e utilizzo.
...
```{r stepAIC, echo=TRUE, results='hide'}
